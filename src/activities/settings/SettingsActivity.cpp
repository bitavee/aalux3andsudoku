...
void SettingsActivity::onEnter() {
  ...
  systemSettings.push_back(
      SettingInfo::Action(StrId::STR_SUDOKU, SettingAction::Sudoku).inSection(StrId::STR_SECT_TOOLS));
...
void SettingsActivity::activateCurrentSetting() {
  ...
  switch (setting.action) {
    ...
    case SettingAction::FileTransfer:
      ...
      break;
    case SettingAction::Sudoku:
      startActivityForResult(std::make_unique<SudokuActivity>(renderer, mappedInput), resultHandler);
      break;
